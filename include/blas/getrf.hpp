...
extern "C"{
  ...
  void sgetrf_(const int*, const int*, const BLAS_S*, const int*, const int*, const int*);
  void sgetri_(const int*, const BLAS_S*, const int*, const int*, const BLAS_S*, const int*, const int*);
  void dgetrf_(const int*, const int*, const BLAS_D*, const int*, const int*, const int*);
  void dgetri_(const int*, const BLAS_D*, const int*, const int*, const BLAS_D*, const int*, const int*);
  void cgetrf_(const int*, const int*, const BLAS_C*, const int*, const int*, const int*);
  void cgetri_(const int*, const BLAS_C*, const int*, const int*, const BLAS_C*, const int*, const int*);
  void zgetrf_(const int*, const int*, const BLAS_Z*, const int*, const int*, const int*);
